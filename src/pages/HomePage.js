        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <div className="flex justify-center gap-10 py-4">
              <Link to={routes.department} className="btn text-xl p-20 uppercase hover:text-blue-600">Danh bạ đơn vị</Link>
              <Link to={routes.staff} className="btn text-xl p-20 uppercase hover:text-blue-600">Danh bạ CBGV</Link>
              <Link to={routes.student} className="btn text-xl p-20 uppercase hover:text-blue-600">Danh bạ sinh viên</Link>
            </div>
          </div>
        </div>
      </div>
